...
<?php /*
                                ...
                                */ ?>
                                <td class="project-label">
                                    <a ui-sref="root.api-endpoints.existing.<?= $modelClassPluralId ?>.existing.edit.continue-editing({dataEnvironment: $root.activeDataEnvironment.slug, active<?= $modelClassSingular ?>Id: <?= lcfirst($modelClassSingular) ?>.id})">{{<?= lcfirst($modelClassSingular) ?>.item_label}}</a>
<?php /*
                                    <br/>
...
<?php /*
                                ...
                                */ ?>
                                <td class="project-actions">
                                    <a ui-sref="root.api-endpoints.existing.<?= $modelClassPluralId ?>.existing.view({dataEnvironment: $root.activeDataEnvironment.slug, active<?= $modelClassSingular ?>Id: <?= lcfirst($modelClassSingular) ?>.id})"
                                       href="#" class="btn btn-white btn-sm"><i class="fa fa-folder"></i> View </a>
                                    <a ui-sref="root.api-endpoints.existing.<?= $modelClassPluralId ?>.existing.edit.continue-editing({dataEnvironment: $root.activeDataEnvironment.slug, active<?= $modelClassSingular ?>Id: <?= lcfirst($modelClassSingular) ?>.id})"
