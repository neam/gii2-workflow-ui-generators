...
<div class="<?= \yii\helpers\Inflector::camel2id(StringHelper::basename($generator->modelClass), '-', true) ?>-form">
    ...
    <?= "<?php " ?>$form = ActiveForm::begin(['layout' => '<?= $generator->formLayout ?>', 'enableClientValidation' =>
    false]); ?>
...
EOS;
    ...
    ?>";
        ...
        <?= "<?= " ?>Html::submitButton('<span class="glyphicon glyphicon-check"></span> '.($model->isNewRecord ?
        'Create' : 'Save'), ['class' => $model->isNewRecord ?
